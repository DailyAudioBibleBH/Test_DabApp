...
{
	public class DabMediaNotificationManager : IMediaNotificationManager
	{
		...
		public DabMediaNotificationManager(Context appliactionContext, MediaSessionCompat.Token sessionToken, Type serviceType)
		{
